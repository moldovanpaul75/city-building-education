...
public class TilePanel extends JPanel {
    ...
    public TilePanel(int tileHeight, int tileWidth, int panelCols, int panelRows, List<Tile> tileList) {
        ...
        tileList.forEach(t->{
            ...
            MapTile tile = new MapTile(imageIcon, this, t.getTileId()-1, t.getTileType().getLayerType().getLayerId(), t.getxCoord(), t.getyCoord());
            tiles.add(tile);
            this.add(tile);
        });
